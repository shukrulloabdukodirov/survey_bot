...
namespace Base\Application\Application\Utils\Telegram\Buttons;
use DefStudio\Telegraph\Enums\ReplyButtonType;
use \DefStudio\Telegraph\Keyboard\ReplyButton as Button;
...
class ReplyButton extends Button
{
    ...
    public static function make(string $label): \DefStudio\Telegraph\Keyboard\ReplyButton
    {
    ...
    public function toArray(): array
    {
        ...
        if (count($this->callbackData) > 0) {
            $data['callback_data'] = implode(';', $this->callbackData);
        }
